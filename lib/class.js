...
function define(namespace, api) {
    ...
    _.forEach(config.members, function (property) {
        Object.defineProperty(klass.prototype, property, {
            get: util.memberGetterSetter('get' + util.capitaliseFirstLetter(property),klass.prototype),
            set: util.memberGetterSetter('set' + util.capitaliseFirstLetter(property),klass.prototype)
        });
    });
