...
function define(namespace, api) {
    ...
    if (namespace == 'auto' || (!namespace && module.exports.autoGenerateNamsesapce)) {
    ...
    if (_.has(api, 'constructor')) {
        ...
        klass = (function (parent) {
            ...
            originConstructor = parent.constructor;
    ...
    klass.toString = (function(name,originConstructorString){
        return function(func){
            return func? originConstructorString :"[class " + name + "]";
        }
    })(config.name,originConstructor.toString(true));
